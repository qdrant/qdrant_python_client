...
class PayloadOpsAnyOf1DeletePayload(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, keys, points, *args, **kwargs):  # noqa: E501
        """PayloadOpsAnyOf1DeletePayload - a model defined in OpenAPI
