...
class SearchParamsAnyOf(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'hnsw': (SearchParamsAnyOfHnsw,),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, hnsw, *args, **kwargs):  # noqa: E501
        """SearchParamsAnyOf - a model defined in OpenAPI

        Args:
            hnsw (SearchParamsAnyOfHnsw):
