...
class PayloadOpsAnyOfSetPayload(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'payload': ({str: (PayloadInterface,)},),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, payload, points, *args, **kwargs):  # noqa: E501
        """PayloadOpsAnyOfSetPayload - a model defined in OpenAPI

        Args:
            payload ({str: (PayloadInterface,)}):
