...
class PointOpsAnyOf1(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, delete_points, *args, **kwargs):  # noqa: E501
        """PointOpsAnyOf1 - a model defined in OpenAPI

        Args:
            delete_points (PointOpsAnyOf1DeletePoints):
