...
class PayloadInterface(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """PayloadInterface - a model defined in OpenAPI

        Args:

        Keyword Args:
            type (str): defaults to nulltype.Null, must be one of ["geo", ]  # noqa: E501
            value (PayloadVariantForGeoPoint): defaults to nulltype.Null  # noqa: E501
