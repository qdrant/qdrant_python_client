...
class PointInsertOpsAnyOfBatch(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'ids': ([int],),  # noqa: E501
            'vectors': ([[float]],),  # noqa: E501
            'payloads': ([{str: (PayloadInterface,)}, none_type], none_type,),  # noqa: E501
        }
    ...
    def __init__(self, ids, vectors, *args, **kwargs):  # noqa: E501
        """PointInsertOpsAnyOfBatch - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            payloads ([{str: (PayloadInterface,)}, none_type], none_type): [optional]  # noqa: E501
        """
