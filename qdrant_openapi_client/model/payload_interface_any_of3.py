...
class PayloadInterfaceAnyOf3(ModelNormal):
    ...
    def __init__(self, value, *args, **kwargs):  # noqa: E501
        """PayloadInterfaceAnyOf3 - a model defined in OpenAPI

        Args:
            value (PayloadVariantForGeoPoint):

        Keyword Args:
            type (str): defaults to "geo", must be one of ["geo", ]  # noqa: E501
