...
class StorageTypeAnyOf1(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """StorageTypeAnyOf1 - a model defined in OpenAPI

        Args:

        Keyword Args:
            type (str): defaults to "mmap", must be one of ["mmap", ]  # noqa: E501
