...
class StorageOpsAnyOf2(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, change_aliases, *args, **kwargs):  # noqa: E501
        """StorageOpsAnyOf2 - a model defined in OpenAPI

        Args:
            change_aliases (StorageOpsAnyOf2ChangeAliases):
        ...
        self.change_aliases = change_aliases
