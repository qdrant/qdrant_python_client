...
class PointOpsAnyOf(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, upsert_points, *args, **kwargs):  # noqa: E501
        """PointOpsAnyOf - a model defined in OpenAPI

        Args:
            upsert_points (PointInsertOps):
        ...
        self.upsert_points = upsert_points
