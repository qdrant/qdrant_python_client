...
class PayloadInterfaceAnyOf1(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'value': (PayloadVariantForInt64,),  # noqa: E501
        }
    ...
    def __init__(self, value, *args, **kwargs):  # noqa: E501
        """PayloadInterfaceAnyOf1 - a model defined in OpenAPI

        Args:
            value (PayloadVariantForInt64):

        Keyword Args:
            type (str): defaults to "integer", must be one of ["integer", ]  # noqa: E501
